...
try:
    ...
    publist = driver.find_elements(By.CSS_SELECTOR, value="[data-testid='tile-title_testID']")

    pub_names = [driver.execute_script("return arguments[0].textContent;", element) for element in publist]
